    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0"> <!-- Centered elements -->
                ...
                <li class="nav-item">
                    <a class="nav-link" href="admin_houses.jsp">Houses</a>
                </li>
                <li class="nav-item">
            ...
            if (sessions != null && sessions.getAttribute("adminId") != null) {
                // User is logged in
                int userId = (int) sessions.getAttribute("adminId");
                String username = (String) sessions.getAttribute("adminUsername");
            %>
            ...
            <% } else {
            	response.sendRedirect("admin_login.jsp"); // Redirect to admin_login.jsp if session is null
            %>
                <a href="admin_login.jsp" class="btn btn-outline-primary">Login</a>
            <% } %>
        </div>
    </div>
</nav>
